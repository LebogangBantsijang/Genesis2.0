...
import com.lebogang.vibe.databinding.FragmentDeezerViewArtistBinding
import com.lebogang.vibe.network.models.ArtistDeezer
import com.lebogang.vibe.network.models.TrackDeezer
import com.lebogang.vibe.ui.adapters.ItemDeezerAlbumArtistSongAdapter
import com.lebogang.vibe.ui.adapters.utils.OnDeezerAudioClickListener
...
class ViewArtistDeezerFragment : Fragment(), OnDeezerAudioClickListener{
    private val viewBinding: FragmentDeezerViewArtistBinding by lazy{
        FragmentDeezerViewArtistBinding.inflate(layoutInflater) }
    ...
    private val adapter = ItemDeezerAlbumArtistSongAdapter().apply {
        listener = this@ViewArtistDeezerFragment }
