...
package com.lebogang.genesis.data.repositories.local
...
import com.lebogang.genesis.data.utils.LocalArtUri
...
class LocalAudio(private val context:Context) {
    ...
    val SORT_AUDIO_BY_TITLE = "$TITLE ASC"
    val SORT_AUDIO_BY_DATE = "$DATE_ADDED DESC"
