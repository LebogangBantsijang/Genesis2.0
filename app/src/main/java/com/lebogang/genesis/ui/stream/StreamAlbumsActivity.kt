...
import com.lebogang.genesis.databinding.ActivityStreamAlbumsBinding
import com.lebogang.genesis.ui.ItemClickInterface
import com.lebogang.genesis.ui.Type
import com.lebogang.genesis.ui.stream.adapters.AlbumAdapter

class StreamAlbumsActivity : AppCompatActivity() {
    private val bind:ActivityStreamAlbumsBinding by lazy{ActivityStreamAlbumsBinding.inflate(layoutInflater)}
